...
{
    public class SyncSecondStartupTask : ISyncStartupTask
    {
        private readonly MainStartupDependentService _dependentService;

        public SyncSecondStartupTask(MainStartupDependentService dependentService)
        {
        ...
        {
            _dependentService.SecondSyncStartupTaskCompleted = true;
        }
    }
}